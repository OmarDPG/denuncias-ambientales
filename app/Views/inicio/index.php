      ...
      <section id="formSection" class="py-12 px-8 bg-surface">
          <div class="max-w-4xl mx-auto">
              <div class="bg-surface-container-lowest rounded-2xl p-8 md:p-12 shadow-sm border border-outline-variant/20">
                  ...
                  <form method="post" id="complaintForm" class="space-y-12" action="<?php echo base_url('inicio/submit'); ?>">
                      <!-- Step 1: Details -->
                      ...
                      <div id="step2" class="step-content space-y-8 pt-8 border-t border-surface-container">
                          ...
                          <div class="space-y-2">
                              ...
                              <select id="tipoDenuncia" required
                                  ...
                                  <option value="residuos-especiales">Residuos de Manejo Especial</option>
                                  <option value="contaminacion-atmosferica">Contaminación Atmosférica</option>
                                  <option value="contaminacion-auditiva">Contaminación Auditiva</option>
                                  <option value="contaminacion-visual">Contaminación Visual</option>
